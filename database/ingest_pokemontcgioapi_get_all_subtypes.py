...
# script variables
pokemontcgioapi_object = 'subtypes'

def get_object():
     #Get all subtypes
     pokemon_subtypes_list = pokemontcgsdk.Subtype.all()
     pokemon_subtypes_df = pd.DataFrame(pokemon_subtypes_list)

     return pokemon_subtypes_df
...
if __name__ == "__main__":
     pokemon_subtypes_df = get_object()
     write_dataframe_to_json(pokemon_subtypes_df, pokemontcgioapi_object, uuid.uuid4())
     # print(pokemon_subtypes_df)