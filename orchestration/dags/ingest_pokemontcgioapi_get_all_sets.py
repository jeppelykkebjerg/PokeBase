...
def ingest_pokemontcgioapi_get_all_sets():
    ...
    @task
    def write_sets_dataframe_to_json(data_frame, pokemontcgioapi_object, uuid):
    ...
    pokemon_sets_df = get_sets()
    write_sets_dataframe_to_json(pokemon_sets_df, pokemontcgioapi_object, uuid.uuid4())

# Instantiate the DAG
ingest_pokemontcgioapi_get_all_sets()